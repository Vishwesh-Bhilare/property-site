const properties = {
    ...
    */
    "property2": {
    title: "Bungalow with Land",
    description: `For Sale: Serene 2.5 Acre Farm in Mulshi Taluka with Stunning Lake Views

    Nestled on the picturesque Panshet-Varasgaon road, just 4 km from Surya Shibir, 
    this tranquil 2.5-acre farm offers a slice of paradise. Enjoy an array of 
    fruit-bearing Kesar mangoes, coconuts, mahogany trees, and lush bamboo, 
    complemented by a variety of medicinal plants. You'll also find an impressive 
    selection of papaya, banana, jackfruit, jamun, mulberry, and litchi trees.

    The charming 2,000 sq. ft. farmhouse, constructed with local laterite stone, 
    is perfectly situated with breathtaking lake views and direct access to the 
    backwaters. The property features fully developed landscaping, ensuring a serene, 
    natural environment.

    Additional highlights include:
    - 13 lakh liters of water storage
    - MSEB power supply
    - Road access right to the farmhouse
